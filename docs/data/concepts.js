window.SCIML_CONCEPTS = {
  nodes: [
    ...
    },
    {
      ...
      math: 'L = Σi wi(θ) Li,   wi ↓ if earlier loss is large',
    ...
    },
    {
      ...
      math: 'u = Σk ûk ϕk,   learning speed depends on k',
    ...
    },
    {
      ...
      math: 'fit trajectory ≠ identify vector field',
